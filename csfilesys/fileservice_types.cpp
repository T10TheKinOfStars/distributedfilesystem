...
RFileMetadata::RFileMetadata(const RFileMetadata& other5) {
  ...
  deleted = other5.deleted;
  version = other5.version;
  owner = other5.owner;
  contentLength = other5.contentLength;
...
RFileMetadata& RFileMetadata::operator=(const RFileMetadata& other6) {
  ...
  deleted = other6.deleted;
  version = other6.version;
  owner = other6.owner;
  contentLength = other6.contentLength;
...
RFile::RFile(const RFile& other7) {
  meta = other7.meta;
  content = other7.content;
  __isset = other7.__isset;
}
RFile& RFile::operator=(const RFile& other8) {
  meta = other8.meta;
